...
df = read.csv('/Users/codytuttle/Documents/GitHub/cfpb_blog/NFWBS_PUF_2016_data.csv')
...
write.csv(df, file = "/Users/codytuttle/Documents/GitHub/cfpb_blog/cfpb_clean.csv")